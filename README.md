...
- 이 튜토리얼은 C++ 개발자가 C#으로 CAD 엔진을 개발할 수 있도록 돕습니다.
- C++ ↔ C# 비교표: 문법, 메모리 모델, 클래스 구조 등 비교 요약
- OpenNurbs 목표 설명: 향후 CAD 디렉토리와 관련된 계획을 간단히 소개할 예정입니다.
...
- [제네릭 설계 철학](./A.%20시작하기%20%26%20언어%20철학/05-generic_설계철학.md)
